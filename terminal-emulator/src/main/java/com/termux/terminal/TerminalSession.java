...
public final class TerminalSession extends TerminalOutput {
    ...
    public void updateSize(int columns, int rows, int cellWidthPixels, int cellHeightPixels) {
        if (mEmulator == null) {
            ...
            JNI.setPtyWindowSizeSafe(mTerminalFileDescriptor, rows, columns, cellWidthPixels, cellHeightPixels);
    ...
    public void initializeEmulator(int columns, int rows, int cellWidthPixels, int cellHeightPixels) {
        ...
        mTerminalFileDescriptor = JNI.createSubprocessSafe(mShellPath, mCwd, mArgs, mEnv, processId, rows, columns, cellWidthPixels, cellHeightPixels);
        ...
        new Thread("TermSessionWaiter[pid=" + mShellPid + "]") {
            @Override
            public void run() {
                int processExitCode = JNI.waitForSafe(mShellPid);
    ...
    void cleanupResources(int exitStatus) {
        ...
        JNI.closeSafe(mTerminalFileDescriptor);
    }

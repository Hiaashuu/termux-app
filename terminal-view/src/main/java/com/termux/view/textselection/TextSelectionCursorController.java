    ...
    public void setActionModeCallBacks() {
        final ActionMode.Callback callback = new ActionMode.Callback() {
            ...
            public boolean onCreateActionMode(ActionMode mode, Menu menu) {
                ...
                menu.add(Menu.NONE, ACTION_CUT, Menu.NONE, android.R.string.cut).setShowAsAction(show);
            ...
            public boolean onActionItemClicked(ActionMode mode, MenuItem item) {
                ...
                switch (item.getItemId()) {
                    ...
                    case ACTION_CUT:
                        ...
                        terminalView.mTermSession.onCopyTextToClipboard(textToCut);
                        terminalView.deleteSelectedTextIfOnCurrentLine();
                        terminalView.stopTextSelectionMode();
                        break;
                    case ACTION_PASTE:
                        terminalView.stopTextSelectionMode();
                    ...
                    case ACTION_SELECT_ALL:
                        ...
                        while (mSelY2 > cursorRow) {
                            String rowText = terminalView.mEmulator.getScreen().getSelectedText(0, mSelY2, mSelX2, mSelY2);
